...
public class WFCancel extends WFCommon {
    ...
    public static Result doCancelAccepted(int reservationId) {
        ...
        if (form.hasErrors()) {
            ...
            context.getReservationDAO().updateReservationStatusAndAppendMessage(reservationId, ReservationStatus.CANCELLED, comments);
            trip.appendMessage(comments);
    ...
    public static Result doCancelLate(int reservationId, boolean soft) {
        ...
        if (soft) {
            ...
            if (form.hasErrors()) {
                ...
                String comments = form.get().remarks;
                rdao.updateReservationStatusAndAppendMessage(reservationId, ReservationStatus.CANCELLED_LATE, comments);
                trip.appendMessage(comments);
