...
import be.ugent.degage.db.dao.api.*;
import be.ugent.degage.db.jdbc.api.*;
...
public class JDBCDataAccessContext implements DataAccessContext {
	...
	@Override
	public CarApprovalDAO getCarApprovalDAO() {
		return new JDBCCarApprovalDAO(this);
	}
    ...
    @Override
    public CarApiDAO getCarApiDAO() {
        return new JDBCCarApiDAO(this);
    }

    @Override
    public InvoiceDAO getInvoiceDAO() {
        return new JDBCInvoiceDAO(this);
    }

    @Override
    public PaymentDAO getPaymentDAO() {
        return new JDBCPaymentDAO(this);
    }

    @Override
    public PaymentInvoiceDAO getPaymentInvoiceDAO() {
        return new JDBCPaymentInvoiceDAO(this);
    }

    @Override
    public CodasDAO getCodasDAO() {
        return new JDBCCodasDAO(this);
    }

    @Override
    public ReminderDAO getReminderDAO() {
        return new JDBCReminderDAO(this);
    }

    @Override
    public PaymentStatisticsDAO getPaymentStatisticsDAO() {
        return new JDBCPaymentStatisticsDAO(this);
    }

    @Override
    public PropertyDAO getPropertyDAO() {
        return new JDBCPropertyDAO(this);
    }

    @Override
    public AutoDAO getAutoDAO() {
        return new JDBCAutoDAO(this);
    }

    @Override
    public CarInsuranceDAO getCarInsuranceDAO() {
        return new JDBCCarInsuranceDAO(this);
    };
