...
public class InfoSession {
    ...
    public InfoSession(int id, InfoSessionType type, Instant time, Address address, int hostId, String hostName, int maxEnrollees, String comments, String description) {
        this.id = id;
        this.type = type;
        this.time = time;
